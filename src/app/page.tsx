          ...
          <div className="container mx-auto px-4">
            ...
            >
             ...
             <div className="mt-8 flex justify-center gap-4">
                <Button asChild>
                    <Link href="https://share.google/hAEhk3Rr4UeMvWz1G" target="_blank">Read more reviews</Link>
                </Button>
                <Button asChild>
                    <Link href="https://share.google/yCpYlbYBe259n6zr5" target="_blank">More student feedback</Link>
                </Button>
            </div>
          </div>
      </section>
